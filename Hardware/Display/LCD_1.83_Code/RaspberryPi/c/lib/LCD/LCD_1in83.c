...
void LCD_1IN83_Clear(UWORD Color)
{
    ...
    LCD_1IN83_DC_1;
    for (j=0; j<LCD_1IN83.HEIGHT; j++) {
        DEV_SPI_Write_nByte((uint8_t *)&Image, LCD_1IN83.WIDTH * 2);
    }
...
void LCD_1IN83_Display(UWORD *Image)
{
    ...
    LCD_1IN83_DC_1;
    for (j=0; j<LCD_1IN83.HEIGHT; j++) {
        DEV_SPI_Write_nByte((uint8_t *)&Image[j * LCD_1IN83.WIDTH], LCD_1IN83.WIDTH * 2);
    }
}
