...
// Standard aliases
#define LCD_Init() LCD_1IN83_Init(HORIZONTAL)
#define LCD_Clear(color) LCD_1IN83_Clear(color)
#define LCD_Display(img) LCD_1IN83_Display(img)
#define LCD_DisplayWindows(x1, y1, x2, y2, img) LCD_1IN83_DisplayWindows(x1, y1, x2, y2, img)
#define LCD_SetBacklight(val) LCD_1IN83_SetBackLight(val)
